...
public class adapterFavoritas extends BaseAdapter {
    ...
    public adapterFavoritas(Activity a,ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        titulox.setText(evento.get(favoritas.TAG_recetaTitulo));
        descripcion.setText(evento.get(favoritas.TAG_recetaVotos));
        minutos.setText(evento.get(favoritas.TAG_recetaTiempo));
        id_.setText(evento.get(favoritas.TAG_recetaId));
        
        url_.setText(evento.get(favoritas.TAG_recetaPathImg));
        texto.setText(evento.get(favoritas.TAG_receta_text));
        
       
     
       
        imageLoader.DisplayImage(evento.get(favoritas.TAG_recetaPathImg), thumb_image);
        return vi;
    }
}
